...
//function that runs when the index.html loads a.k.a welcome screen
//return none
function welcome(){
...
/*loads the questions for the specific quiz a.k.a quiz view
param  qnum = quiz number
       q    = question number
...
function quiz(qnum,q=0,ans=false){
	...
	//generates the choices for the answer 
